...
### Compute VIF of attributes in model, via statsmodels


#(a) Compute VIF without any transformation to data
...
print "---"
print "Q: What is the VIF?"
for i in range(len(vif)):
  print "---"
  print "Attribute: %s"%X_train_cols[i]
  print "VIF: %s"%vif[i]
  print "---"
print "---"


# (b) Compute VIF with centering of mean of each attribute
...
vif_center=[variance_inflation_factor(X_train_center, i) for i in range(X_train_center.shape[1])]

print "---"
print "Q: What is the VIF of centered data?"
for i in range(len(vif)):
  print "---"
  print "Attribute: %s"%X_train_cols[i]
  print "VIF: %s"%vif_center[i]
  print "---"
print "---"
